...
1. dedicated worker / cron / queue consumer を足す
2. broker-like publisher を real broker adapter へ置き換える
3. subscriber ごとの failure policy / replay を分ける
4. trace / metrics / structured logging を強化する
5. payment workflow を saga / compensation まで広げる
