...
さらに深めるなら、次は **Sprint 10〜12** をこの第1区切りの後半として進めます。
詳細は `docs/19-sprint7-12-roadmap.md` を参照してください。

1. Sprint 10: trace / metrics / structured logging を強化する
   - 実装タスク分解: `docs/25-sprint10-observability-strengthening.md`
   - 補助資料: `docs/26-telemetry-vs-audit-log-and-business-events.md`
2. Sprint 11: payment workflow を saga / compensation まで広げる
3. Sprint 12: bounded context / ACL / 「フル採用か部分採用か」の判断へつなぐ
