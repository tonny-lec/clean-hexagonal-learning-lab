...
- **Adapters**: in-memory / SQLite / PostgreSQL / outbox / read model / payment / console / broker-like / subscribers / worker / HTTP / CLI / batch
...
さらに深めるなら、次は **Sprint 8〜12** をこの第1区切りの後半として進めます。
詳細は `docs/19-sprint7-12-roadmap.md` を参照してください。

1. Sprint 8: broker-like publisher を real broker adapter へ進める
2. Sprint 9: subscriber ごとの failure policy / replay / re-drive
3. Sprint 10: trace / metrics / structured logging を強化する
4. Sprint 11: payment workflow を saga / compensation まで広げる
5. Sprint 12: bounded context / ACL / 「フル採用か部分採用か」の判断へつなぐ
