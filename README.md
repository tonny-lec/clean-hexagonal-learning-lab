...
- **Adapters**: in-memory / SQLite / PostgreSQL / outbox / read model / payment / fulfillment / console / broker-like / nats / subscribers / worker / HTTP / CLI / batch
...
さらに深めるなら、次は **Sprint 12** でこの第1区切りを締めます。
詳細は `docs/19-sprint7-12-roadmap.md` を参照してください。

1. Sprint 12: bounded context / ACL / 「フル採用か部分採用か」の判断へつなぐ
